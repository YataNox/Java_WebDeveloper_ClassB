...
// 생성자(Constructor)
// 클래스의 객체가 생성될 때, 멤버필드의 초기화를 위해서 사용되는 메서드
// 각각의 객체가 생성될 때, 서로 다른 메모리를 가지는 객체를 생성할 수 있게 됩니다.

// 생성자의 특징
// 1. 메소드입니다.(특별한 멤버 메소드 - 처음 객체 생성시에만 호출, 중간에 호출되지 않습니다.)
...
{	
	public static void main(String[] args)
	{
		...
		// 객체가 만들어질때만 호출되기 때문에 다른 메소드처럼 호출 객체와 함께
		// 사용되지 않습니다.
		// a1.Aclass();  에러
