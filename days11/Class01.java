...
class First
{
	int n1;
	int n2;
	// 속성(멤버 필드, 멤버 변수, 필드) : 클래스에 속한 정보(변수)들.
	// 속성은 변수로 생성하며 클래스의 멤버 필드라고도 호칭합니다.
...
public class Class01 
{
	public static void main(String[] args)
	{
		...
		// 레퍼런스 변수와 new에 의해 만들어진 공간이 합쳐지면,
		// 이를 객체라고 부릅니다.
		a1 = new First();
		// 위와 같이 공간이 할당되면 이제부터. n1, n2 변수가 사용이 가능합니다.
		First a2 = new First();
		// 객체가 두 개가 만들어지면, a1에도 n1, n2가 생성되고,
		// a2에도 n1, n2가 생성되므로, 그들을 구분하기 위해
		// a1.n1, a1.n2, a2.n1, a2.n2로 사용합니다.
