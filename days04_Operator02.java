...
public class Operator02 
{
	public static void main(String args[])
	{
		...
		// 연산의 순서
		n = n + 10; // 다음과 같이 간략하게도 사용합니다. n += 10;
		// 1. 현재 n값(50)과 두 번째 피연산자인 10이 CPU로 전달되서 덧셈됩니다.
		// 2. 연산된 결과가 돌아와서 다시 n 변수에 저장됩니다.
		...
		// 앞 또는 뒤가 차이가 나는 곳은 다른 연산에 섞여 있을 때 입니다.
		System.out.println("현재 n값 : " + n);
		System.out.println("println(n++) -> n : " + n++);
		//다른 연산 참여 후 1증가
		System.out.println("출력 연산 후 n 값 : " + n);
