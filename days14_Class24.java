...
class StaticD
{
	...
	//다만 인스턴스 메서드는 객체 생성 후 이용 가능합니다.
	public static void setCount(int count) {StaticD.count = count;}
	public static int getCount() {return StaticD.count;}
...
public class Class24 
{
	...
	{
		// private로 지정된 static 멤버는 클래스의 외부에서 접근이 차단됩니다.
		// StaticD.count = 100; // 에러
		// public 접근 지정자를 사용하는 static 메소드로 private로 지정된
