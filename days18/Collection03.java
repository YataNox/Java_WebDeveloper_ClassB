...
// 컬렉션 프레임웍에서 제네릭의 사용
// 보통의 컬렉션 프레임웤은 여러 타입이 혼용되어 저장은 가능하지만 실제로 혼용되어 저장되는
// 경우는 거의 없습니다.
// 다만, 컬렉션 클래스의 입력, 반환에 관련한 모든 메서드들은 Object 타입을 기반으로 하기 때문에
// 컬렉션에서 데이터 인출(.get())시에 강제 형변환을 해야하는 불편함이 존재합니다.
// 이러한 문제점을 해결하기 위해 JDK 1.5 버전 이후에는 제네릭 문법을 지원합니다.
// 제네릭 문법을 사용하지 않은 ArrayList의 사용 -----------------------------------------
// ArrayList a = new ArrayList();
// a.add(100);
// Integer i = (Integer)a.get(0); // 다시 꺼내어 쓸 때 강제 형변환이 반드시 필요
...
// new 다음의 클래스명에서 제네릭 타입을 생략할 수 있음
