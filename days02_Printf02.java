...
public class Printf02
{
	public static void main(String[] args) 
	{
		...
		// 실수의 자리수 조절
		// 숫자를 안 쓴 경우 : 소수점 윗 자리는 필요한만큼 확보, 아래자리는 6자리 확보
		System.out.printf("실수%f실수\n", 123.123);
		// 숫자를 쓴 경우
		// %10.2f :  총 10자리 확보 후 소수점 한 자리 소수점 아래 숫자 2자리로 할당
		//				  따라서 소수점 윗 자리 숫자는 7자리가 할당됩니다.
		// 소수점 윗자리는 정수처럼 모자르면 추가 확보, 남으면 공백으로 채웁니다.
