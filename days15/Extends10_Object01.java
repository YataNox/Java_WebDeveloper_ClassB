...
// Subclass extends Super 라는 건 Subclass는 Object 클래스를 상속하지 않지만
// Super 클래스가 Object 클래스를 상속하므로, Subclass는 Object 클래스를
...
public class Extends10_Object01 
{
	public static void main(String[] args)
	{
		...
		// hashCode 메소드는 해당 객체의 해시 코드 값(다른 객체와 구분하기 위한 고유 값)을
		// 리턴해주는 메소드(JVM에 의해서 관리되고 있는 번호
